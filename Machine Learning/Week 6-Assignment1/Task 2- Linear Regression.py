...
df = pd.read_csv(r"C:\Users\Rukham Ijaz\Downloads\zameencom-property-data-By-Kaggle-Short.csv",delimiter=";",index_col="property_id")
...
df.plot.scatter(x='bedrooms', y='price', title='Scatter Plot of bedrooms and price percentages');
plt.show()
...
price = calc(regressor.coef_, regressor.intercept_, 9.5)
print(price)

#pridict “price’ for testing data based on testing data for “bedrooms”
